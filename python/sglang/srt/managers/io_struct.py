...
class PinPrefixReqInput(BaseReq):
    """Pin a prefix in hierarchical cache."""
    prefix_hash: str = ""
    max_tokens: int = 0


@dataclass
class PinPrefixReqOutput:
    """Response for pin prefix request."""
    success: bool = False
    nodes_pinned: int = 0
    message: str = ""
...
class LoadLoRAAdapterReqOutput:
    """Response for LoRA adapter load."""
    success: bool = False
    message: str = ""
...
class LoadLoRAAdapterFromTensorsReqOutput:
    """Response for LoRA adapter load from tensors."""
    success: bool = False
    message: str = ""
...
class UnloadLoRAAdapterReqOutput:
    """Response for LoRA adapter unload."""
    success: bool = False
    message: str = ""
